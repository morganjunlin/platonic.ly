...
for (let i = 0; i < 2; i++) {
  ...
  let newUser = {
    ...
    descriptions: faker.lorem.sentences(),
  ...
  db.query('INSERT INTO users VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9)', [newUser.id, newUser.email, newUser.passphrase, newUser.first_name, newUser.last_name, newUser.gender, newUser.age, newUser.descriptions, newUser.avg_rating])
